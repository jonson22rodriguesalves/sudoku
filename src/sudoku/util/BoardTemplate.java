...
/**
 * Classe utilitária que contém o template para exibição do tabuleiro.
 * O template usa formatação de string para posicionar os valores.
 */
public final class BoardTemplate {
    ...
    // Template do tabuleiro com placeholders para os valores
